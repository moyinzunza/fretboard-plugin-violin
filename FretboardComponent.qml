...
Item {
    ...
    property var tuning: [55, 62, 69, 76] // default is 4-string classical violin tuning

    function getPitch(string, fret) {
        return tuning[string] + fret;
    }

    readonly property var tpcNoteNamesSolfege: [
        "Fa♭♭", "Do♭♭", "Sol♭♭", "Re♭♭", "La♭♭", "Mi♭♭", "Si♭♭",
        "Fa♭", "Do♭", "Sol♭", "Re♭", "La♭", "Mi♭", "Si♭",
        "Fa", "Do", "Sol", "Re", "La", "Mi", "Si",
        "Fa♯", "Do♯", "Sol♯", "Re♯", "La♯", "E♯", "Si♯",
    ...
    function getNoteName(tpc) {
        ...
        if(solfege.checked){
            var name = tpcNoteNamesSolfege[tpc + 1];
        }else{
    ...
    Column {
        ...
        Loader {
            ...
            onLoaded: {
                item.checked = false;
                item.text = qsTranslate("action", "Solfege Notes");
            }
        }
    ...
    Grid {
        ...
        property int frets: 18
        property int strings: 4
        property bool leftHanded: true
        ...
        property var dots: []
        property var doubleDots: [2, 4, 5, 7]
        ...
        Repeater {
            ...
            delegate: ItemDelegate {
                ...
                Loader {
                    ...
                    opacity: fretRect.marked ? 1.0 : 0.80
