...
MuseScore {
    id: plugin
    version:  "0.6.0"
    description: "Simple violin fretboard to visualise and edit tablature scores (based on dmitrio95 plugin)"
    ...
    Component.onCompleted: {
        if (compatibility.useApi4) {
            plugin.title = "Fretboard Violin";
            plugin.categoryCode = "note-input";
        } else {
            plugin.menuPath = "Plugins.Fretboard Violin";
